...
Perturbation::Perturbation(const int s, const ParameterSetting &parameters, const Solution &solution)
	: scenario(s), params(parameters), sol_temp(solution), rng(std::random_device{}())
{
	// ----------------------------------------------------------------------------------------------------------
