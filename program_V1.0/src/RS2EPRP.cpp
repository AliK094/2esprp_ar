...
void RS2EPRP::RetrieveSolutions(IloCplex &cplex)
{
	...
	sol.routesWarehouseToCustomer = warmStart.routesWarehouseToCustomer;
	sol.customerAssignmentToWarehouse = warmStart.customerAssignmentToWarehouse;
...
void RS2EPRP::CalculateCostsForEachPart()
{
	...
	cout << "setupCost (RS2EPRP) = " << sol.setupCost << endl;
	cout << "productionCost (RS2EPRP) = " << sol.productionCost << endl;
	cout << "holdingCostPlant (RS2EPRP) = " << sol.holdingCostPlant << endl;
	cout << "transportationCostPlantToWarehouse (RS2EPRP) = " << sol.transportationCostPlantToWarehouse << endl;
	cout << "objValue_FE (RS2EPRP) = " << objValue_FE << endl;

	cout << "Avg holding cost warehouse (RS2EPRP) : " << sol.holdingCostWarehouse_Avg << endl;
	cout << "Avg holding cost customer (RS2EPRP) : " << sol.holdingCostCustomer_Avg << endl;
	cout << "Avg cost of unmet demand (RS2EPRP) : " << sol.costOfUnmetDemand_Avg << endl;
	cout << "Avg transportation cost warehouse to customer (RS2EPRP) : " << sol.transportationCostWarehouseToCustomer_Avg << endl;
	...
	for (int s = 0; s < params.numScenarios; ++s)
	{
		for (int t = 0; t < params.numPeriods; ++t)
		{
			for (int i = 0; i < params.numCustomers; ++i)
			{
				...
				{
					cout << "deliveryQuantityToCustomer[" << i + params.numWarehouses << "][" << t + 1 << "][" << s + 1 << "] = " << sol.deliveryQuantityToCustomer[i][t][s] << endl;
				}
			}
		}
	}
